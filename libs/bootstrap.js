  ...
  Button.prototype.toggle = function () {
    ...
    if (jQueryparent.length) {
      var jQueryinput = this.jQueryelement.find('input')
        .prop('checked', !this.jQueryelement.hasClass('active'))
        .trigger('change')
      if (jQueryinput.prop('type') === 'radio') jQueryparent.find('.active').removeClass('active')
    }
...
+function (jQuery) { "use strict";
  ...
  Carousel.prototype.to = function (pos) {
    ...
    if (this.sliding)       return this.jQueryelement.one('slid', function () { that.to(pos) })
...
+function (jQuery) { "use strict";
  ...
  function clearMenus() {	
    ...
    jQuery(toggle).each(function (e) {
      ...
      //Henry - Parent do dropdown sumia após o evento
      jQueryparent.show();
    })
  }
